...
<body style="background-color: #e3f2fd;">
  ...
  <footer class="fixed-bottom bg-dark text-white text-center py-2">
    <p class="mb-0">&copy;//Shree Lekha.S(212223110052)</p>
  </footer>
...
<body class="bg-info">
  ...
  <footer class="bg-dark text-white text-center py-2 mt-5">
    <p>&copy; //Shree Lekha.S(212223110052)</p>
  </footer>
...
![alt text](<Screenshot 2024-05-10 233139.png>)



![alt text](<Screenshot 2024-05-10 233152.png>)



![alt text](<Screenshot 2024-05-10 233207.png>)




![alt text](<Screenshot 2024-05-10 233228.png>)
